<?php if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validatedLink) {
        ...
        if ($imageInfo !== false) {
            ...
            echo "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta name='viewport' content='width=device-width, initial-scale=1.0'> <title>Link Content Display</title> </head> <body> <h2>Content of the Link</h2> <img src='" .
                $validatedLink .
                "' alt='Embedded Image'> </body> </html>";
        } else {
            // If the content is not an image, display it as plaintext
            echo "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta name='viewport' content='width=device-width, initial-scale=1.0'> <title>Link Content Display</title> </head> <body> <h2>Content of the Link</h2> <p>" .
